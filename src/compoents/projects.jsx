...
function ShowProjects(){
    return(
        <div className="mt-12">
        <h1 className="font-bold text-4xl"><span className="text-red-500">Personal </span>Projects</h1>
        <div className="mt-8 flex flex-cols overflow-y-hidden gap-x-4">
            <div className="bg-red-500 p-2 h-1/4 w-1/3 lg:w-1/5 rounded-lg max-w-sm">
